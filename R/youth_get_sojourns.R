get_youth_sojourns <- function(vm,short=30, Output=NULL, Site = NULL, epoch = 1, difference = 15, threshold = 100){
  ...
  # } else{
  #   message('Can\'t find RData/Sojourn Grids.RData. Using the provided
  #   settings for difference, threshold, and short.')
  # }
